          ...
          <div className="flex flex-col gap-10 lg:grid lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
            <div className="flex flex-col gap-6 text-lg font-semibold">
              ...
              <p>
                ...
                content on the marketing site, as well as an instructor
                dashboard where they can view classes assigned to them and
                eventually payments etc.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-4 text-left text-lg font-semibold">
              ...
              <div className="flex flex-col gap-2">
                ...
                <ul className="list-disc list-inside ml-4">
                  ...
                  <li>
                    Regeneration of future classes when the parent class is
                    updated
                  </li>
                </ul>
              </div>
