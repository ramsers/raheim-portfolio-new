      ...
      <main className="flex flex-col gap-10 w-full row-start-2 items-center text-left">
        ...
        <div className="flex flex-col items-center gap-6 w-full max-w-5xl">
          <p className="text-lg font-semibold">
            ...
            Instagram DMs, or basic plug-ins to manage schedules, bookings, and
            passes. Or pay a pretty penny for a heavy software they will only
            need/use a small portion of.
          </p>
